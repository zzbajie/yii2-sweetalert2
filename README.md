...
```
php composer.phar require zzbajie/yii2-sweetalert2 "dev-master"
```

or add

```
"zzbajie/yii2-sweetalert2": "dev-master"
```
...
View:
```
<?= \zzbajie\sweetalert2\Alert::widget(['useSessionFlash' => true]) ?>
```

Controller:
```
<?php
 Yii::$app->session->setFlash(\zzbajie\sweetalert2\Alert::TYPE_SUCCESS, 'Congratulations!');

```
also
```
<?php
 Yii::$app->session->setFlash(\zzbajie\sweetalert2\Alert::TYPE_SUCCESS, [
    [
        'title' => 'Your title',
        'text' => 'Your message',
